...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_SIMPLE_DEFAULT(14), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), ZAP_ATTRIBUTE_MASK(READABLE) }, /* FeatureMap */              \
        ...
        { ZAP_SIMPLE_DEFAULT(1), 0x00000000, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(READABLE) },    /* NumberOfPositions */        \
        { ZAP_SIMPLE_DEFAULT(0), 0x00000001, 1, ZAP_TYPE(INT8U), ZAP_ATTRIBUTE_MASK(READABLE) },    /* CurrentPosition */          \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 16, 25 }, { ZAP_CLUSTER_INDEX(16), 4, 8 }, { ZAP_CLUSTER_INDEX(20), 3, 8 },                        \
        { ZAP_CLUSTER_INDEX(23), 3, 8 },  { ZAP_CLUSTER_INDEX(26), 3, 8 }, { ZAP_CLUSTER_INDEX(29), 3, 8 },                        \
    }
...
#define FIXED_DEVICE_TYPES                                                                                                         \
    { { 0x00000012, 1 }, { 0x00000016, 4 }, { 0x0000000F, 1 }, { 0x0000000F, 1 },                                                  \
      { 0x0000000F, 1 }, { 0x0000000F, 1 }, { 0x0000000F, 1 } }

// Array of device type offsets
#define FIXED_DEVICE_TYPE_OFFSETS { 0, 2, 3, 4, 5, 6 }

// Array of device type lengths
#define FIXED_DEVICE_TYPE_LENGTHS { 2, 1, 1, 1, 1, 1 }
